...
public class MySynchronizationScript : MonoBehaviour, IPunObservable
{
    ...
    private Vector3 positionOfGamePlane = new Vector3(0f,0f,96.1f);
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        if (stream.IsWriting)
        {
            ...
            stream.SendNext(rb.position - positionOfGamePlane);
        ...
        else
        {
            ...
            networkedPosition = (Vector3)stream.ReceiveNext() + positionOfGamePlane;
